# @erboladaiorg/impedit-recusandae-atque

> forked from [@erboladaiorg/impedit-recusandae-atqueode](https://www.npmjs.com/package/@erboladaiorg/impedit-recusandae-atqueode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@erboladaiorg/impedit-recusandae-atqueode/issues/300).

[![npm version](https://img.shields.io/npm/v/@erboladaiorg/impedit-recusandae-atque.svg)](https://www.npmjs.com/package/@erboladaiorg/impedit-recusandae-atque)
[![Downloads](https://img.shields.io/npm/dm/@erboladaiorg/impedit-recusandae-atque.svg)](https://www.npmjs.com/package/@erboladaiorg/impedit-recusandae-atque)
[![Build Status](https://github.com/erboladaiorg/impedit-recusandae-atque/workflows/CI/badge.svg)](https://github.com/erboladaiorg/impedit-recusandae-atque/actions)
...
```sh
npm install --save-dev eslint @erboladaiorg/impedit-recusandae-atque
```
...
```js
const nodePlugin = require("@erboladaiorg/impedit-recusandae-atque")
...
💼 [Configurations](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/erboladaiorg/impedit-recusandae-atque#-configs).\
...
`@erboladaiorg/impedit-recusandae-atque` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/erboladaiorg/impedit-recusandae-atque/releases)
